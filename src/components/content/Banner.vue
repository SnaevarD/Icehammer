...
<template>
  <div class="container container--large">
    <div class="banner">
      <div class="info">
        <h1 class="title">Biggest GT of the Year in Iceland!</h1>
        <!-- <router-link to="/">
  ...
  <div class="textContainer container container--medium">
    <p>On the weekend of April 15h and 16th , we will see Iceland´s biggest  Warhammer 40.000 event of the year. where the best of the best will fight out for the title as the best ICE HAMMER player.</p>
